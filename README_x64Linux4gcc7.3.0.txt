...
data type carBasicInfo from car_basic_info.idl.
This example builds two applications, named car_basic_info_publisher and
car_basic_info_subscriber.
...
> make -f makefile_car_basic_info_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_car_basic_info_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the car_basic_info_publisher.cxx
file where it says:
...
Run /home/liquidxhendrix/rti_connext_dds-6.1.0/resource/scripts/rtisetenv_x64Linux4gcc7.3.0.bash
...
> objs/x64Linux4gcc7.3.0/car_basic_info_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/car_basic_info_subscriber -d <domain_id> -s <sample_count>
