######################################################################
# makefile_car_basic_info_x64Linux4gcc7.3.0#
...
ifndef NDDSHOME
NDDSHOME := "/home/liquidxhendrix/rti_connext_dds-6.1.0"
endif
...
CDRSOURCES    = car_basic_info.idl
SOURCES = $(SOURCE_DIR)car_basic_infoPlugin.cxx $(SOURCE_DIR)car_basic_info.cxx $(SOURCE_DIR)car_basic_infoSupport.cxx
COMMONSOURCES = $(notdir $(SOURCES))

EXEC          = car_basic_info_subscriber car_basic_info_publisher
...
objs/$(TARGET_ARCH)/%.o : $(SOURCE_DIR)%.cxx   $(SOURCE_DIR)car_basic_info.h 
...
#
#
#  $(SOURCE_DIR)car_basic_infoPlugin.cxx $(SOURCE_DIR)car_basic_info.cxx $(SOURCE_DIR)car_basic_infoSupport.cxx \
#  $(SOURCE_DIR)car_basic_info.h $(SOURCE_DIR)car_basic_infoPlugin.h $(SOURCE_DIR)car_basic_infoSupport.h $(SOURCE_DIR)application.h : \
#		$(SOURCE_DIR)car_basic_info.idl
#	$(NDDSHOME)/bin/rtiddsgen $(SOURCE_DIR)car_basic_info.idl -replace -language C++
#
